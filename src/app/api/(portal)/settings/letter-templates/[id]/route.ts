...
// GET /api/settings/letter-templates/[id] - Get a specific letter template
...
// PUT /api/settings/letter-templates/[id] - Update a letter template
...
// DELETE /api/settings/letter-templates/[id] - Delete a letter template
