...
('11111111-1111-1111-1111-111111111111', 'aaaa1111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111',
...
('22222222-2222-2222-2222-222222222222', 'bbbb1111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
...
('33333333-3333-3333-3333-333333333333', 'cccc1111-1111-1111-1111-111111111111', '33333333-3333-3333-3333-333333333333',
...
('44444444-4444-4444-4444-444444444444', 'dddd1111-1111-1111-1111-111111111111', '44444444-4444-4444-4444-444444444444',
...
('55555555-5555-5555-5555-555555555555', 'eeee1111-1111-1111-1111-111111111111', '55555555-5555-5555-5555-555555555555',
...
-- Closed referrals
('66666666-6666-6666-6666-666666666666', 'aaaa2222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111',
...
('77777777-7777-7777-7777-777777777777', 'bbbb2222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222',
...
-- Notes for 22222222 (Maria Garcia)
('22222222-2222-2222-2222-222222222222', 'Initial contact made with patient. Appointment scheduled for next week.', 'manual', NULL, NULL, NOW() - INTERVAL '4 days'),
('22222222-2222-2222-2222-222222222222', 'Status updated from Scheduling to Appointment', 'status_change', 'Scheduling', 'Appointment', NOW() - INTERVAL '3 days'),

-- Notes for 33333333 (Robert Johnson)
('33333333-3333-3333-3333-333333333333', 'Patient came in for consultation. Good candidate for LASIK.', 'manual', NULL, NULL, NOW() - INTERVAL '6 days'),
('33333333-3333-3333-3333-333333333333', 'Status updated from Scheduling to Appointment', 'status_change', 'Scheduling', 'Appointment', NOW() - INTERVAL '6 days'),
('33333333-3333-3333-3333-333333333333', 'Quote provided to patient. Reviewing financing options.', 'manual', NULL, NULL, NOW() - INTERVAL '5 days'),
('33333333-3333-3333-3333-333333333333', 'Status updated from Appointment to Quote', 'status_change', 'Appointment', 'Quote', NOW() - INTERVAL '5 days'),

-- Notes for 44444444 (Susan Williams)
('44444444-4444-4444-4444-444444444444', 'Complex case reviewed by surgical team. Approved for surgery.', 'manual', NULL, NULL, NOW() - INTERVAL '10 days'),
('44444444-4444-4444-4444-444444444444', 'Surgery scheduled for next Monday.', 'manual', NULL, NULL, NOW() - INTERVAL '7 days'),
('44444444-4444-4444-4444-444444444444', 'Status updated to Procedure', 'status_change', 'Quote', 'Procedure', NOW() - INTERVAL '7 days'),

-- Notes for closed referral 66666666 (Linda Davis)
('66666666-6666-6666-6666-666666666666', 'Patient completed LASIK procedure successfully.', 'manual', NULL, NULL, NOW() - INTERVAL '25 days'),
('66666666-6666-6666-6666-666666666666', 'Post-op day 1: Vision 20/20, no complications.', 'manual', NULL, NULL, NOW() - INTERVAL '24 days'),
('66666666-6666-6666-6666-666666666666', 'Post-op week 1: Excellent healing, patient very satisfied.', 'manual', NULL, NULL, NOW() - INTERVAL '18 days'),
('66666666-6666-6666-6666-666666666666', 'Final follow-up complete. Referral closed.', 'manual', NULL, NULL, NOW() - INTERVAL '10 days');
